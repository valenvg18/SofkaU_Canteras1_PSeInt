	...
	Repetir
		...
		Segun opcionmenu Hacer
			1:
				...
				SiNo
					...
					Mientras (usuarios <= 8) Y (masusuarios = 1) Hacer
						...
						Mientras (usuario = us1) O (usuario = us2) O (usuario = us3) O (usuario = us4) O (usuario = us5) O (usuario = us6) O (usuario = us7) O (usuario = us8) Hacer
							Escribir "Ese usuario ya se encuentra registrado.";
							Leer usuario;
						FinMientras
						...
						Escribir "¿Este usuario aprobó el curso?"; 
				...
				masusuarios <- 1;
			2:
				Escribir "Escriba el nombre del usuario qeu desea consultar";
				Leer buscarnombre;
